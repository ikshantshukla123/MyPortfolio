        ...
        <div className="w-full">
            ...
            <div className="mt-5 space-y-8">
                {projectsData.slice().map((project, index) => (
                    <div key={index} className="border-l-2 border-neutral-700 pl-4 transition ease-in-out duration-300 hover:border-emerald-500">
                        <div className="p-2">
                            {/* Project Header */}
                            <div className="mb-3">
                                ...
                                <div className="flex items-center gap-4 text-sm">
                                    {project.liveLink && (
                                        <Link
                                            ...
                                            className="text-emerald-400 hover:text-emerald-300 transition-colors duration-300 inline-flex items-center gap-1"
                                            target="_blank"
                                    ...
                                    <Link
                                        ...
                                        className="text-neutral-300 hover:text-emerald-400 transition-colors duration-300 inline-flex items-center gap-1"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        GitHub
                            ...
                            <ul className="ml-2 space-y-1 mb-4">
                                {project.description.map((desc, idx) => (
                                    <li key={idx} className="text-neutral-400 text-xs leading-relaxed flex items-start">
                                        <span className="text-emerald-500 mr-2 mt-1 text-xs">•</span>
